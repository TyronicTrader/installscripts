...
sudo dnf install qtxdg-tools-devel qt6-qttools qt6-qttools-assistant qt6-cmake cmake-qtgui qmake-qt6 qt6-qtbase-tools qt6-qtdeclarative plasma6-ksshaskpass qtxdg-tools-devel qt6-qtbase-theme-gtk3 --assumeyes --refresh
